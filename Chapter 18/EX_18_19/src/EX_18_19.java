...
public class EX_18_19 extends Application{
    ...
    public void start(Stage primaryStage) {
        ...
        HBox arrowButtons = new HBox(10);
        Button button1 = new Button("+");
        Button button2 = new Button("-");
        arrowButtons.getChildren().addAll(button1,button2);
        arrowButtons.setAlignment(Pos.BOTTOM_CENTER);
        ...
        borderPane.setBottom(arrowButtons);

        // Create a scene and place it in the stage
        Scene scene = new Scene(borderPane, 600, 510);
